<?php  
	...
	// proses perhitungan beasiswa
	// menangkap data alternatif
	$sqlAlter = "SELECT * FROM data_alternatif";
	$alterMahasiswa = mysqli_query($koneksi_db, $sqlAlter);
	...
	if ($jmlHasilNorm && $jmlHasilPref) {
		...
		while ($nama = mysqli_fetch_assoc($alterMahasiswa)) {
			...
			Nama_Mahasiswa, data_penilaian.ID_Kriteria, data_kriteria.Atribut, data_kriteria.Nama_Kriteria, data_penilaian.Nilai 
			FROM data_penilaian INNER JOIN data_kriteria ON data_penilaian.ID_Kriteria = data_kriteria.ID_Kriteria INNER JOIN 
			data_alternatif ON data_penilaian.ID_Alter = data_alternatif.ID_Alter WHERE Nama_Mahasiswa = '$nama[Nama_Mahasiswa]'");
		...
		while ($nama = mysqli_fetch_assoc($alterMahasiswa)) {
			...
			// menangkap data penilaian dari masing" kriteria berdasarkan nama alternatif
			$queryNilai = mysqli_query($koneksi_db, "SELECT data_penilaian.ID_Penilaian, data_penilaian.ID_Alter, data_alternatif.
			Nama_Mahasiswa, data_penilaian.ID_Kriteria, data_kriteria.Atribut, data_kriteria.Nama_Kriteria, data_penilaian.Nilai FROM 
