<?php  
    ...
    $queryAlt= mysqli_query($koneksi_db, "SELECT COUNT(Nama_Mahasiswa) FROM data_alternatif");
...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h4 mb-0 text-gray-800 text-uppercase">Sistem Penentuan Pemberian Beasiswa</h1>
</div>
