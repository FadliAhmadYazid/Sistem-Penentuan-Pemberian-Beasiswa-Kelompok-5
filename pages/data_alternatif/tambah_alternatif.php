...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
  <h1 class="h3 text-gray-800">Tambah Data Mahasiswa</h1>
</div>
...
<div class="card mb-4 rounded-0">
    <div class="card-header bg-white py-3 d-flex">
        <h6 class="m-0 text-gray-800">Masukkan Data Mahasiswaiswa Baru</h6>
    </div>
    <div class="card-body">
        <form action="pages/data_alternatif/proses_tambah_alternatif.php" method="post">
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Nama Mahsiswa</label>
                <input type="text" class="form-control rounded-0" id="exampleFormControlInput1" name="nama_mahasiswa" placeholder="Masukkan Nama Mahasiswa"required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-control rounded-0" aria-label="Default select example" name="semester">
            ...
            <a href="index.php?page=data_mahasiswa" class="btn btn-secondary btn-square rounded-0">
