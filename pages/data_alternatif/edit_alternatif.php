...
<div class="d-sm-flex align-items-center justify-content-between mb-1">
  <h1 class="h3 text-gray-800">Edit Data Mahasiswa</h1>
</div>

<!-- DataTales Example -->
<div class="card mb-4 rounded-0">
    <div class="card-header bg-white py-3 d-flex">
        <h6 class="m-0 text-gray-800">Edit Data Mahasiswa</h6>
    </div>
    <div class="card-body">
        <form action="pages/data_alternatif/proses_edit_alternatif.php?id=<?= $_GET['edit']; ?>" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control rounded-0" id="exampleFormControlInput1" name="nama_mahasiswa" 
            ...
            <div class="mb-4">
                ...
                <select class="form-control rounded-0" aria-label="Default select example" name="Semester" required>
                    <option selected value="<?= $data['Semester']; ?>" class="bg-secondary text-white"><?= $data['Semester']; ?></option>
                    <?php  
                        for ($i = 1; $i <= 9; $i++) :
                    ?>
