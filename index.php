...
<head>
    ...
    <title>BeaSmart - Kelompok 5</title>
    ...
    <style type="text/css">
        * {
        ...
        .sidebar {
            background-color: #1e3a78; /* Darker blue */
        }
        ...
        .btn-custom:hover {
            background-color: #162d5d; /* Darker shade for hover */
            border-color: #162d5d;
            color: white;
        }
        ...
        .border-left-info {
            border-left: .25rem solid #1e3a78 !important;
            border-left-color: #1e3a78 !important;
        }
        ...
        <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?page=dashboard">
                <div class="sidebar-brand-icon p-0">
                    <img src="assets/img/logo_beasiswa.png" alt="LOGO BEASISWA" class="img-profile">
                </div>
                <div class="sidebar-brand-text text-left font-weight-bold judul-navbar">BeaSmart</div>
            </a>
